<template>
  <div id="projects">
    <div class="py-20">
      ...
      <div
        v-for="project in projectsIndescendingOrder"
        :key="project.id"
...
const projects = ref<projectTypes[]>([
  ...
  },
  {
    ...
    description: "Simple, professional title, emphasizing a showcase purpose.",
...
const projectsIndescendingOrder = computed(() => {
